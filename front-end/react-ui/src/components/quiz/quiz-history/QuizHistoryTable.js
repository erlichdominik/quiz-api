...
const QuizHistoryTable = ({ quizHistory }) => {
  ...
  return (
    <div
      className={`bg-white h-[30rem] border border-primaryblue rounded-lg grid auto-rows-max grid-cols-3 text-center w-1/2 mx-auto gap-y-4 overflow-y-scroll scroll-smooth`}
    >
